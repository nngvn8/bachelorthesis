...
\begin{definition}
	...
	Let TS = \transitionsystem be a transition system and \grpfct a grouping function. A \emph{\viewN} \view{\viewppty} is a transition system $(\states', \actions',\transitionrel', \initstates', \labelingfct')$ \redcomment{that is derived from TS with the \grpfctN \grpfct} where
