...
\begin{definition}
	...
	Let \chgph = \chgphtuple be a \chosengraphtypeN and \grpfct a grouping function. A \emph{\viewN} \view{\viewppty} is a \chosengraphtypeN $\mdp' = \chgphtupledist$ \redcomment{that is derived from \mdp with the \grpfctN \grpfct} where
	...
	\begin{itemize}
		...
		\item $\trans' = \{ (\eqclassv{\state_1}, \action, \eqclassv{\state_2}) \mid \exists \state_1 \in \eqclassv{\state_1} \exists \state_2 \in \eqclassv{\state_2} : (\eqclassv{\state_1}, \action, \eqclassv{\state_2}) \in \trans\}$%\subseteq \states' \times \actions' \times \states'$
