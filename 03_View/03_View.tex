...
The definition of a \viewN is dependend on a given transition system and a grouping function \grpfct. We derive the equivalnce relation \eqrelview as in Definition \ref{def:R} and use its equivalence classes \eqclassv{s} as states for the \viewN. The rest of the transition system is structured accordingly.
