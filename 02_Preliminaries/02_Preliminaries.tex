...
\subsection{\redcomment{Mathematical Fundamentals}}
\redcomment{e.g.strongly connected components, equivalence relation, more?}

\redcomment{we denote \eqclass{a}{R} for the equivalence class with the representative a under the equivalence relation R}

\redcomment{how much should be included? ...probably no set theory}
