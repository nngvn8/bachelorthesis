...
% EXAMPLE VIEWS
\newcommand{\pptydistance}{\mt{\longleftrightarrow}}
...
\newcommand{\gfctparamvalueseq}{\mt{\grpfct[\var = \varval]}}
\newcommand{\gfctparamvaluesneq}{\mt{\grpfct[\var \neq \varval]}}
\newcommand{\gfctparamdnf}{\mt{\grpfct[VarDNF]}}
\newcommand{\gfctparamcnf}{\mt{\grpfct[VarCNF]}}
\newcommand{\gfctparamvalueseqopt}[1][\varval]{\mt{\grpfct[\var = #1]}}
\newcommand{\gfctparamvalident}[1][\varval]{\mt{\grpfct[\pptyparamvalident{#1}]}}
\newcommand{\gfctdistance}{\mt{\grpfct[\pptydistance]}}
\newcommand{\gfcthascycle}{\mt{\grpfct[\exists\cycle]}}
\newcommand{\gfctexactcycle}[1][\mt{n}]{\mt{\grpfct[\pptyexactcycle{#1}]}}
\newcommand{\gfctcycleset}{\mt{\grpfct[\pptycycleset]}}
\newcommand{\gfctexactactcycle}[1][\mt{n}]{\mt{\grpfct[\pptyexactactcycle{#1}]}}
...
\newcommand{\viewparamvalident}[1][\varval]{\mt{\view[\pptyparamvalident{#1}]}}
\newcommand{\viewdistance}{\mt{\view[\pptydistance]}}
\newcommand{\viewhascycle}{\mt{\view[\exists\cycle]}}
\newcommand{\viewexactcycle}[1][\mt{n}]{\mt{\view[\pptyexactcycle{#1}]}}
\newcommand{\viewcycleset}{\mt{\view[\pptycycleset]}}
\newcommand{\viewexactactcycle}[1][\mt{n}]{\mt{\view[\pptyexactactcycle{#1}]}}
