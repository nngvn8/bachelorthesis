...
\begin{definition}
	Let $\chgph$ be an \chgphN. The set $\cycleset := \{ \cycle \mid \lencycle(\cycle) \geq n\}$ declares the set of all cycles in \chgph with at least length $n$.
\end{definition}
...
\begin{definition}
	...
	\]
	and $\imggrp = \powerset{\states} \cup \remset.$
\end{definition}
