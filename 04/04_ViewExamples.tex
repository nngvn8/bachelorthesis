...
\begin{figure}[h]
	...
	\end{minipage}
	\caption{Simplified representations of \mdp (left) and the \viewN \viewminoutaction on it (right)}
...
\begin{figure}[h]
	...
	\end{minipage}
	\caption{Simplified representations of \mdp (left) and the \viewN \viewmaxoutaction on it (right)}
...
\begin{figure}[h]
	...
	\end{minipage}
	\caption{Simplified representations of \mdp (left) and the \viewN \viewspanoutaction on it (right)}
