...
\begin{document}
	...
	\begin{tikzpicture} [every initial by arrow/.style={thick}]
		...
		\node [above right=-4pt of s1] (ls1) {$1.2$};
		\node [above right=-6pt of s2] (ls2) {$1$};
		\node [above right=-4pt of s3] (ls3) {$1$};
		\node [above right=0pt and -8pt of s4] (ls4) {$1$};
		\node [above right=-4pt of s5] (ls5) {$1$};
		\node [below left=-4pt of s6] (ls6) {$1$};
		\node [below left=-4pt of s7] (ls7) {$1$};
		\node [above left=-4pt of s8] (ls8) {$1$};
		\node [above left=-4pt of s9] (ls9) {$1$};
		\node [above right=-4pt of s10] (ls10) {$1$};
