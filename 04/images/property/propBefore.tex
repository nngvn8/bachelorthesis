...
\begin{document}
	...
	\begin{tikzpicture} [every initial by arrow/.style={thick}]
		...
		\node [above right=-4pt of s1] (ls1) {$0.1$};
		\node [above right=-6pt of s2] (ls2) {$0.2$};
		\node [above right=-4pt of s3] (ls3) {$0.41$};
		\node [above right=0pt and -8pt of s4] (ls4) {$-0.6$};
		\node [above right=-4pt of s5] (ls5) {$0.93$};
		\node [below left=-4pt of s6] (ls6) {$0.59$};
		\node [below left=-4pt of s7] (ls7) {$2.06$};
		\node [above left=-4pt of s8] (ls8) {$-0.95$};
		\node [above left=-4pt of s9] (ls9) {$-0.99$};
		\node [above right=-4pt of s10] (ls10) {$0.15$};
