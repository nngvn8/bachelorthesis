...
\begin{document}
	...
	\begin{tikzpicture} [scale=2.4, every initial by arrow/.style={thick}]
		...
		\node [gstate,init] (s1) at (\basex,\basey) {\{$\state_1, \state_{10}$\}};
		...
		\node [above right=15pt of s1.center] {$0$};
		\node [above right=15pt of s236.center] {$0.4$};
		\node [above left=15pt of s489.center] {$-0.8$};
		\node [above right=15pt of s57.center] {$2$};
