...
\begin{definition}
	Let $\chgph = \chgphtuple$ be \chgphN an \arbset be and arbitrary set \redcomment{with $\remelem \in \arbset$}. We call any function $\grpfct : \states \to \imggrp$ a \emph{\grpfctN}. The symbol \viewppty is a unique identifier.
