...
\begin{definition}
	Let $\chgph = \chgphtuple$ be \chgphN, \smstates a subset of \states and \arbset be an arbitrary set \redcomment{with $\remelem \in \arbset$}. We call any function $\grpfct : \states \to \imggrp$ with
