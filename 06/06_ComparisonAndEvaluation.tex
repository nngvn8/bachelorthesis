...
\begin{figure}
	\begin{lstlisting}[language=CustomC, caption={PRISM model file, where modules define the two systems mentioned in the text},label={lst:0602prismbefore}]
		mdp
...
\begin{figure}
	\begin{lstlisting}[language=CustomC, caption={PRISM model file},label={lst:0603sccloopsbefore}]
mdp
...
\begin{figure}
	\begin{lstlisting}[language=CustomC, caption={Fixed model file},label={lst:0603sccloopsafter}]
mdp
